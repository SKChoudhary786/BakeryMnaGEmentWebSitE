...
function spin() {
  ...
  let SnB30off = shuffle([1890, 2250, 2610]);
  let SnBChocohamp = shuffle([1850, 2210, 2570]); //Kemungkinan : 100%
  ...
  if (SnB30off.includes(Hasil[0])) SelectedItem = "slicenbites 30% Off";
  if (SnBChocohamp.includes(Hasil[0])) SelectedItem = "slicenbites Hamper";
